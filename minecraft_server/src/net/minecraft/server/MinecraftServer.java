...
import net.minecraft.src.NaNRuntime;
...
public class MinecraftServer implements Runnable, ICommandListener {
	public static Logger logger = Logger.getLogger("NaN");
	...
	private boolean startServer() throws UnknownHostException {
		...
		logger.info("Starting NaN server");
		...
		this.nanManager = new NaNManager(this);
	...
	public static void main(String[] var0) {
		...
		try {
			...
			if(!NaNRuntime.isHeadless() && (var0.length <= 0 || !var0[0].equals("nogui"))) {
