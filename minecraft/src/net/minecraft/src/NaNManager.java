...
public final class NaNManager {
	...
	public static final int EFFECT_ECHO_SMEAR = 41;
	public static final int EFFECT_SUBLIMINAL_FLASH = 42;
	...
	public static int echoSmearTicks;
	public static int subliminalFlashTicks;
	public static int voidSlicesTicks;
	public static int wireframeBloodTicks;
	public static int vertigoCrushTicks;
	...
	public static void beginEffect(int effectId, int durationTicks) {
		...
		echoSmearTicks = effectId == EFFECT_ECHO_SMEAR ? activeTicks : 0;
		subliminalFlashTicks = effectId == EFFECT_SUBLIMINAL_FLASH ? activeTicks : 0;
		voidSlicesTicks = effectId == EFFECT_VOID_SLICES ? activeTicks : 0;
		wireframeBloodTicks = effectId == EFFECT_WIREFRAME_BLOOD ? activeTicks : 0;
		vertigoCrushTicks = effectId == EFFECT_VERTIGO_CRUSH ? activeTicks : 0;
	...
	private static int effectDuration(int effectId) {
		...
		if(effectId == EFFECT_VIEWPORT_STROKE || effectId == EFFECT_DEPTH_DECAY ||
			...
			effectId == EFFECT_TV_STATIC) return 20 * 10;
		if(effectId == EFFECT_TEXTURE_PANIC) return 20 * 60;
		if(effectId == EFFECT_ECHO_SMEAR || effectId == EFFECT_SUBLIMINAL_FLASH ||
			effectId == EFFECT_VOID_SLICES || effectId == EFFECT_WIREFRAME_BLOOD ||
			effectId == EFFECT_VERTIGO_CRUSH) return 20 * 10;
	...
	private static int nextEffectId(int effectId) {
		...
		if(effectId == EFFECT_ECHO_SMEAR) return EFFECT_SUBLIMINAL_FLASH;
