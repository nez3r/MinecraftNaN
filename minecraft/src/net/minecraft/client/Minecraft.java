...
import net.minecraft.src.NaNManager;
...
public abstract class Minecraft implements Runnable {
	...
	public static File getMinecraftDir() {
		if(minecraftDir == null) {
			String var0 = System.getProperty("nan.gameDir");
			minecraftDir = var0 == null ? getAppDir("minecraft") : new File(var0);
			if(!minecraftDir.exists() && !minecraftDir.mkdirs()) {
				throw new RuntimeException("The game directory could not be created: " + minecraftDir);
			}
		}
	...
	public static void startMainThread(String var0, String var1, String var2) {
		boolean var3 = Boolean.getBoolean("nan.fullscreen");
		int var4 = getLaunchInt("nan.width", 854);
		int var5 = getLaunchInt("nan.height", 480);
		Frame var6 = new Frame("Minecraft");
		Canvas var7 = new Canvas();
		var6.setLayout(new BorderLayout());
		var6.add(var7, "Center");
		var7.setPreferredSize(new Dimension(var4, var5));
		var6.pack();
		if(!Boolean.getBoolean("nan.mobile") && !isMobileRuntime()) {
			var6.setLocationRelativeTo((Component)null);
		}
		MinecraftImpl var8 = new MinecraftImpl(var6, var7, (MinecraftApplet)null, var4, var5, var3, var6);
		Thread var9 = new Thread(var8, "Minecraft main thread");
		var9.setPriority(10);
		var8.minecraftUri = "www.minecraft.net";
		if(var0 != null && var1 != null) {
			var8.session = new Session(var0, var1);
		} else {
			var8.session = new Session("Player" + System.currentTimeMillis() % 1000L, "");
		}

		if(var2 != null) {
			String[] var10 = var2.split(":");
			var8.setServer(var10[0], Integer.parseInt(var10[1]));
		}

		var6.setVisible(true);
		var6.addWindowListener(new GameWindowListener(var8, var9));
		var9.start();
	}
	...
	public static void main(String[] var0) {
		String var1 = getLaunchString(var0, "--username", "Player" + System.currentTimeMillis() % 1000L);
		String var2 = getLaunchString(var0, "--session", getLaunchString(var0, "--accessToken", "-"));
		String var3 = getLaunchString(var0, "--server", null);
		String var4 = getLaunchString(var0, "--port", null);
		System.setProperty("nan.mobile", getLaunchBoolean(var0, "--mobile") ? "true" : System.getProperty("nan.mobile", "false"));
		if(var3 != null && var4 != null) {
			var3 = var3 + ":" + var4;
		}
		String var5 = getLaunchString(var0, "--gameDir", null);
		if(var5 != null) {
			System.setProperty("nan.gameDir", var5);
		}
		String var6 = getLaunchString(var0, "--width", null);
		String var7 = getLaunchString(var0, "--height", null);
		if(var6 != null) System.setProperty("nan.width", var6);
		if(var7 != null) System.setProperty("nan.height", var7);
		if(getLaunchBoolean(var0, "--fullscreen")) {
			System.setProperty("nan.fullscreen", "true");
		}
		func_6269_a(var1, var2);
	}

	private static boolean isMobileRuntime() {
		String var0 = System.getProperty("java.vm.name", "").toLowerCase();
		String var1 = System.getProperty("os.name", "").toLowerCase();
		return var0.indexOf("dalvik") >= 0 || var0.indexOf("art") >= 0 || var1.indexOf("android") >= 0;
	}

	private static String getLaunchString(String[] var0, String var1, String var2) {
		for(int var3 = 0; var3 < var0.length - 1; ++var3) {
			if(var1.equals(var0[var3])) return var0[var3 + 1];
		}
		return var2;
	}

	private static boolean getLaunchBoolean(String[] var0, String var1) {
		for(int var2 = 0; var2 < var0.length; ++var2) {
			if(var1.equals(var0[var2])) return true;
		}
		return false;
	}

	private static int getLaunchInt(String var0, int var1) {
		try {
			return Integer.parseInt(System.getProperty(var0, Integer.toString(var1)));
