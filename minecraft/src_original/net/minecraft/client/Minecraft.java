...
public abstract class Minecraft implements Runnable {
	...
	public void startGame() throws LWJGLException {
		...
		Display.setTitle("Minecraft NaN");
	...
	public void runTick() {
		...
		if(!this.herobrineErrorShown && this.gameStartTime > 0L && this.theWorld != null) {
			...
			if(elapsedTime >= 300000L) { // 5 minutes = 300000 milliseconds
	...
	public void changeWorld(World var1, String var2, EntityPlayer var3) {
		...
		this.theWorld = var1;
		if(var1 != null) {
			// Initialize Herobrine timer when world loads
	...
	private void displayHerobrineError() {
		if(this.thePlayer != null) {
			this.thePlayer.addChatMessage("§4[FATAL ERROR] Float overflow in entity.Herobrine.posX");
			this.thePlayer.addChatMessage("§4[FATAL ERROR] NaN detected in world renderer");
			this.thePlayer.addChatMessage("§c[WARNING] Attempting to recover...");
			this.thePlayer.addChatMessage("§c[WARNING] Entity 'Herobrine' removed from world");
		}
	}
}
